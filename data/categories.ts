...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    accent: '#5a8a30',
    calculators: [
      { id: 'gacha', title: '抽卡模擬', subtitle: '保底機率', comingSoon: true },
      { id: 'expected-value', title: '期望值', subtitle: '機率收益', comingSoon: true },
      { id: 'dice', title: '骰子模擬', subtitle: 'D6、D20', comingSoon: true },
    ],
  },
];
